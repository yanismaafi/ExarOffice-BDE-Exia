    ...
    <div class="container">
      ...
      <div class="row mb-5 justify-content-center">
        <div class="col-md-6 text-center">
          <h2 class="section-title mb-3">Evenement à venir </h2>
            ...
            @foreach ($events as $event)
              ...
              <div class="col-lg-4 col-md-6 mb-5">
                <div class="product-item">
                  <figure>
                    <a href="{{ route('event.show',$event->id) }}"><img src="{{ asset('images/events/'. $event->image) }}" alt="Image" title="{{ $event->name }}" class="img-fluid" style="height:220px"></a>
                  </figure>
                  <div class="px-4">
