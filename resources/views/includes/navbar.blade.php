    ...
    <nav class="site-navigation position-relative text-right" role="navigation">
        ...
        <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
            <li><a href="{{ route('home.index') }}" class="nav-link"> <i class="fa fa-home"></i> {{ __('navbar.home') }}</a></li>
            ...
            {{-- <li><a href="{{ url('locale/en') }}" ><i class="nav-link fa fa-language"></i> en</a></li>
                <li><a href="{{ url('locale/fr') }}" ><i class="nav-link fa fa-language"></i> fr</a></li> --}}
